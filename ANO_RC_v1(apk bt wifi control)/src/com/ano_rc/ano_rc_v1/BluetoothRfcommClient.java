...
public class BluetoothRfcommClient {
    ...
    /**
     * Start the ConnectThread to initiate a connection to a remote device. - device
    ...
    /**
     * Start the ConnectedThread to begin managing a Bluetooth connection - socket -
     * The BluetoothSocket on which the connection was made - device - The
     * BluetoothDevice that has been connected
     */
    ...
    /**
     * Write to the ConnectedThread in an unsynchronized manner - out - The bytes to
     * write - ConnectedThread#write(byte[])
     */
